...
This project is a demonstration project of [TwicPics Components](https://www.twicpics.com/docs/components/next?utm_source=github&utm_medium=organic&utm_campaign=components) using [Next.js](https://nextjs.org/).
...
All you have to do is set your configuration options to the desired values ([see documentation](https://www.twicpics.com/docs/components/next?utm_source=github&utm_medium=organic&utm_campaign=components#setup-options)).
